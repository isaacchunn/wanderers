      ...
      <main className="flex-1">
        ...
        <section className="container px-4 py-12 md:py-24 lg:py-32">
          <div className="mx-auto max-w-[980px] text-center">
            <div className="mb-4 inline-block rounded-lg bg-muted px-3 py-1 text-sm">✨ Your next adventure awaits</div>
            ...
            <p className="mb-8 text-xl text-muted-foreground sm:text-2xl">
              Collaborate with friends and family to create the perfect itinerary. Share ideas, coordinate plans, and
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="group relative rounded-lg border p-6 hover:shadow-lg transition-all">
              ...
              <p className="text-muted-foreground">
                Automatically organize your itinerary with intelligent scheduling suggestions.
              </p>
            </div>
            <div className="group relative rounded-lg border p-6 hover:shadow-lg transition-all">
              ...
              <p className="text-muted-foreground">
                Work together with your travel companions in real-time to plan the perfect trip.
              </p>
            </div>
            <div className="group relative rounded-lg border p-6 hover:shadow-lg transition-all lg:col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="mb-2 text-xl font-bold">Interactive Maps</h3>
              <p className="text-muted-foreground">
                Visualize your journey with interactive maps and location suggestions.
              </p>
            </div>
          </div>
        </section>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="rounded-lg bg-background p-6 shadow-sm">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    "TravelSync made planning our group trip so much easier. Everyone could contribute ideas and we
                    stayed organized throughout."
                  </p>
        ...
        <section className="container px-4 py-12 md:py-24 lg:py-32">
          <div className="mx-auto max-w-[800px] text-center">
            ...
            <p className="mb-8 text-xl text-muted-foreground">
              Join thousands of travelers who are already using TravelSync to plan and organize their trips. Start for
              free today!
            </p>
            <Button size="lg" className="text-base">
